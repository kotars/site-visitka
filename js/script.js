window.addEventListener("DOMContentLoaded", () => {
  ...
  !(function (e, i) {
    ...
    var l = ((e) => (
      ...
      o = ((e) => ((e.Label = "label"), (e.LabelArrow = "labelArrow"), e))(
        o || {}
      );
    ...
    return class {
      ...
      initialize(e, i, s) {
        ...
        if (
          ((this.globalConfig = __spreadValues(__spreadValues({}, d), i)),
          s && (this.dictLocale = s),
          this.isTooltip())
        ) {
        ...
        if (n.plugin) {
          ...
          switch (n.rule) {
            ...
            case l.MaxLength:
              if (void 0 === u) {
                console.error(
                  `Value for ${n.rule} rule for [${r}] field is not defined. The field will be always invalid.`
                ),
                  this.setFieldInvalid(r, n);
                break;
              }
              if ("number" != typeof u) {
                console.error(
                  `Value for ${n.rule} rule for [${r}] should be a number. The field will be always invalid.`
                ),
                  this.setFieldInvalid(r, n);
                break;
              }
            ...
            case l.MaxNumber: {
              ...
              if ("number" != typeof u) {
                console.error(
                  `Value for ${n.rule} rule for [${r}] field should be a number. The field will be always invalid.`
                ),
                  this.setFieldInvalid(r, n);
                break;
              }
            ...
            case l.CustomRegexp: {
              if (void 0 === u)
                return (
                  console.error(
                    `Value for ${n.rule} rule for [${r}] field is not defined. This field will be always invalid.`
                  ),
              ...
              try {
                ...
                console.error(
                  `Value for ${n.rule} rule for [${r}] should be a valid regexp. This field will be always invalid.`
                ),
                  this.setFieldInvalid(r, n);
                break;
              }
            ...
            case l.MinFilesCount:
              ...
              if (
                Number.isFinite(null == c ? void 0 : c.length) &&
                c.length < u
              ) {
                this.setFieldInvalid(r, n);
                break;
            ...
            case l.Files: {
              ...
              if ("object" != typeof u)
                return (
                  console.error(
                    `Value for ${n.rule} rule for [${r}] field should be an object. This field will be always invalid.`
                  ),
                  void this.setFieldInvalid(r, n)
                );
              const e = u.files;
              if ("object" != typeof e)
                return (
                  console.error(
                    `Value for ${n.rule} rule for [${r}] field should be an object with files array. This field will be always invalid.`
                  ),
                  void this.setFieldInvalid(r, n)
                );
              const i = (e, i) => {
      ...
      validateField(e, i = !1) {
        ...
        return (
          ...
          t.isValid &&
            this.setFieldValid(
              e,
              null == (s = t.config) ? void 0 : s.successMessage
            ),
          ...
          i.forEach((i) => {
            ...
            if (
              !(
                i.validator ||
                i.plugin ||
                (i.rule && Object.values(l).includes(i.rule))
              )
            )
              throw Error(
                `Rule should be one of these types: ${Object.values(l).join(
                  ", "
                )}. Provided value: ${i.rule}`
              );
          }),
          (this.fields[e] = { elem: t, rules: i, isValid: void 0, config: s }),
          this.setListeners(t),
      ...
      addRequiredGroup(e, i, s, t) {
        ...
        return (
          (this.groupFields[e] = {
            rules: [{ rule: r.Required, errorMessage: i, successMessage: t }],
            groupElem: l,
            elems: a,
            isDirty: !1,
            isValid: void 0,
      ...
      clearFieldStyle(e) {
        ...
        Object.keys(a).forEach((e) => {
          ...
          r.elem.classList.remove(
            ...n(
              (null == (t = r.config) ? void 0 : t.errorFieldCssClass) ||
      ...
      clearErrors() {
        ...
        for (const s in this.groupFields) {
          ...
          Object.keys(l).forEach((e) => {
            t.elems.forEach((i) => {
              ...
              (i.style[e] = ""),
                i.classList.remove(
                  ...n(
                    (null == (s = t.config) ? void 0 : s.errorFieldCssClass) ||
                      this.globalConfig.errorFieldCssClass
                  )
                );
            });
          ...
          const r =
            (null == (i = t.config) ? void 0 : i.successFieldStyle) ||
            this.globalConfig.successFieldStyle ||
            {};
      ...
      unlockForm() {
        ...
        for (let i = 0, s = e.length; i < s; ++i)
          "true" !==
            e[i].getAttribute("data-just-validate-fallback-disabled") &&
      ...
      renderTooltip(e, i, s) {
        ...
        const {
          ...
          d =
            s ||
            (null == (t = this.globalConfig.tooltip) ? void 0 : t.position);
        switch (d) {
          case "left":
      ...
      createErrorLabelElem(e, i, s) {
        ...
        return (
          ...
          this.globalConfig.testingMode &&
            (t.dataset.testId = `error-label-${e}`),
      ...
      createSuccessLabelElem(e, i, s) {
        ...
        return (
          ...
          this.globalConfig.testingMode &&
            (t.dataset.testId = `success-label-${e}`),
      ...
      renderFieldLabel(e, i, s, t) {
        ...
        if ("checkbox" === e.type || "radio" === e.type) {
          ...
          (null == (r = null == (l = e.parentElement) ? void 0 : l.tagName)
            ...
            ? null ==
                (a =
                  null == (o = e.parentElement) ? void 0 : o.parentElement) ||
              a.appendChild(i)
            : s
      ...
      renderFieldError(e, i) {
          ...
          if (!d.asyncCheckPending) {
            ...
            l &&
              ...
              d.elem.classList.add(
                ...n(
                  (null == (t = d.config) ? void 0 : t.successFieldCssClass) ||
                    this.globalConfig.successFieldCssClass
                )
              );
          }
        ...
        (this.isValid = !1),
          d.elem.classList.add(
            ...n(
              (null == (l = d.config) ? void 0 : l.errorFieldCssClass) ||
                this.globalConfig.errorFieldCssClass
            )
          );
        const u = this.createErrorLabelElem(
          e,
          void 0 !== i ? i : d.errorMessage,
          d.config
        );
        this.renderFieldLabel(
          d.elem,
          u,
          null == (r = d.config) ? void 0 : r.errorsContainer
        ),
          this.isTooltip() &&
            this.tooltips.push(
              this.renderTooltip(
                d.elem,
                u,
                null == (a = null == (o = d.config) ? void 0 : o.tooltip)
                  ? void 0
                  : a.position
              )
            );
              ...
              this.isTooltip() &&
                this.tooltips.push(
                  this.renderTooltip(
                    r.groupElem,
                    o,
                    null == (l = null == (t = r.config) ? void 0 : t.tooltip)
                      ? void 0
                      : l.position
                  )
                );
                  ...
                  l = function (t) {
                    ...
                    if (void 0 === u && "FORM" !== this.nodeName) {
                      ...
                      if (
                        ...
                        return (
                          !1 === d && (t.preventDefault(), t.stopPropagation()),
                          d
                        );
                      }
                      t.preventDefault();
            ...
            a.default.extendAliases({
              datetime: {
                ...
                onUnMask: function (e, t, i) {
                  return t
                    ? S(i.outputFormat, M(e, i.inputFormat, i), i, !0)
                    : t;
                },
                    ...
                    if (
                      ...
                      if (
                        (b.jitOffset[x] &&
                          void 0 === b.validPositions[r.seekNext.call(g, x)] &&
                          !1 !==
                            (S = f.call(g, x + b.jitOffset[x], t, !0, !0)) &&
                          (!0 !== o && (S.caret = x), (O = !0)),
                ...
                if (void 0 === o.validPositions[l] && !r.isMask.call(n, l, !1))
                  if (0 == l ? a.getTest.call(n, l) : o.validPositions[l - 1]) {
                    ...
                    if (
                      ...
                      (((p = s.extend({}, p, {
                        input:
                          a.getPlaceholder.call(n, l, p.match, !0) ||
                          p.match.def,
                      })).generatedInput = !0),
                      v.call(n, l, p, !0),
                      !0 !== i)
  ...
  new Inputmask("+7 (999) 999-99-99").mask(u),
    new JustValidate(".form__items")
      .addField("#name", [
        {
          rule: "minLength",
          value: 2,
