...
var L = (p, f, g) => f in p ? _(p, f, {
    ...
    k = (p, f) => {
        ...
        if (S)
            for (var g of S(f)) Z.call(f, g) && L(p, g, f[g]);
        return p
    };
...
(function (p, f) {
    ...
    class O {
        ...
        validateField(e, t = !1) {
            ...
            s.isValid = !0;
            const r = [];
            return [...s.rules].reverse().forEach(o => {
        ...
        validateGroup(e, t) {
            const s = [];
            return [...t.rules].reverse().forEach(r => {
        ...
        renderTooltip(e, t, s) {
            ...
            const {
                ...
                width: o,
                height: a
            } = e.getBoundingClientRect(), c = t.getBoundingClientRect(), n = s || ((b = this.globalConfig.tooltip) == null ? void 0 : b.position);
            switch (n) {
                case "left": {
        ...
        createErrorLabelElem(e, t, s) {
            ...
            return Object.assign(r.style, i), r.classList.add((s == null ? void 0 : s.errorLabelCssClass) || this.globalConfig.errorLabelCssClass, "just-validate-error-label"), this.isTooltip() && (r.dataset.tooltip = "true"), this.globalConfig.testingMode && (r.dataset.testId = `error-label-${e}`), this.errorLabels[e] = r, r
        }
        ...
        renderErrors(e = !1) {
            ...
            if (!(!this.isSubmitted && !e)) {
                ...
                for (const o in this.groupFields) {
                    ...
                    this.isValid = !1, a.elems.forEach(n => {
                        var h, b;
